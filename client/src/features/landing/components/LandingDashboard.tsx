...
export const LandingDashboard = () => (
  <LandingSection variant="muted" id="dashboard">
    ...
    <div className="overflow-hidden rounded-2xl border border-safety-outline/80 bg-white shadow-panel ring-1 ring-safety-brand/5">
      <div className="flex items-center justify-between border-b border-safety-outline bg-gradient-to-r from-safety-surface to-white px-6 py-4">
      ...
      <div className="grid grid-cols-1 gap-6 p-6 lg:grid-cols-4">
        <div className="mb-4 grid grid-cols-2 gap-4 md:grid-cols-4 lg:col-span-4 lg:grid-cols-8">
          {STATS.map((stat) => (
            <div
              key={stat.label}
              className="rounded-lg border border-safety-outline bg-safety-surface/80 p-4"
            >
