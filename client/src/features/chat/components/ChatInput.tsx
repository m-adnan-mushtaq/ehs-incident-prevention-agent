  ...
  return (
    <div className="shrink-0 border-t border-slate-200 bg-white shadow-[0_-2px_10px_rgba(15,23,42,0.06)]">
      <div className="mx-auto w-full max-w-3xl p-3 md:p-4">
        ...
        <div className="flex items-end gap-1.5 rounded-lg border border-slate-200 bg-slate-50/80 p-1.5 focus-within:border-blue-300 focus-within:ring-2 focus-within:ring-blue-100">
          <input
            ref={fileRef}
            type="file"
            accept="image/*"
          ...
          <Button
            ...
            variant="ghost"
            size="icon"
            className="h-10 w-10 shrink-0 text-slate-600 hover:bg-white hover:text-blue-700"
          ...
          <Textarea
            ...
            className="min-h-10 max-h-32 flex-1 resize-none border-0 bg-transparent px-2 py-2.5 text-sm leading-5 shadow-none focus-visible:ring-0"
            rows={1}
          />
          <Button
            type="button"
